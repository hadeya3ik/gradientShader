    ...
    <main className=" w-screen pt-[68px]">
      <div className=' w-screen flex flex-col items-center pt-8 gap-8 md:pt-16 md:gap-16'>
        <div className='flex flex-col items-center w-min'>
          <h1 className="font-semibold flex-1 px-8 text-4xl md:text-5xl">About</h1>
        ...
        <div className='flex flex-col gap-12 sm:max-w-lg md:max-w-2xl lg:max-w-4xl sm:px-0 px-4'>
          ...
          <div className='flex flex-col gap-2 sm:gap-4'>
            <h1 className='text-2xl sm:text-4xl md:text-5xl'>
              <span className='font-semibold bg-gradient-to-r from-[#FF8FF2] to-[#91bafb] bg-clip-text text-transparent'> Our Vision
              </span>
            </h1>
          ...
          <div className='flex flex-col gap-2 sm:gap-4'>
            <h1 className='text-2xl sm:text-4xl md:text-5xl'>
              <span className='font-semibold bg-gradient-to-r to-[#8fe1a9] from-[#7db1e9] bg-clip-text text-transparent'> Our Story
              </span>
            </h1>
